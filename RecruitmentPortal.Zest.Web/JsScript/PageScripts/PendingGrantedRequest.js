...
$(document).ready(function () {
    ...
    function BindRequestType() {
        function viewRequestModel() {
            ...
            //        var IsValidTempData = false;
            //        $.ajax({
            //            type: 'POST',
            //            url: 'PendingGrantedRequest.aspx/ISValidTempData',
            ...
            //                var Result = result.d;
            //                if (Result == 'true') {
            //                    IsValidTempData = true;
            //                }
            //                else {
            //                    IsValidTempData = false;
            //                }
            //            },
    ...
    $("#btnSearch").on("click", function () {
        ...
        $.ajax({
            type: 'POST',
            url: 'PendingGrantedRequest_HR.aspx/ISValidTempData',
            contentType: 'application/json',
            data: "{}",
            async: false,
            contentType: "application/json; charset=utf-8",
