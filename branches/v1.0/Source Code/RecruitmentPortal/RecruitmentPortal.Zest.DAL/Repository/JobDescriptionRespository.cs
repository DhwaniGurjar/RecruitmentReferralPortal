...
namespace RecruitmentPortal.Zest.DAL.Repository
{
    public class JobDescriptionRespository : IJobDescriptionRepository
    {
        ...
        {
            return this._db.Query<JobDescriptionResult>("SELECT [JD_Id],[Job_Title],[Resource_Designation],[Job_Type],[Department],[Priority],[Job_Experience],[Status],[Salary],[Assign_Hr] FROM [dbJobDescription]").ToList();
        }
