...
<script runat="server">
	...
	/**
	 * This function must check the user TempData to be sure that he/she is
	...
	private bool CheckAuthentication()
	{
		...
		// some kind of TempData validation here. Even something very simple as...
		//
		//		return ( TempData[ "IsAuthorized" ] != null && (bool)TempData[ "IsAuthorized" ] == true );
		//
		// ... where TempData[ "IsAuthorized" ] is set to "true" as soon as the
